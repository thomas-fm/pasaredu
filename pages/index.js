  ...
  return (
    ...
    <div>
        ...
        <div className="container 2xl:mx-20 md:mx-20 md-w-auto flex items-center border-b-4 border-gray-80">
          ...
          <div className="flex w-6/12 my-2 md:w-3/12 2xl:w-3/12 md:mx-10">
            <ul className="space-x-3 flex md:flex 2xl:flex 2xl:space-x-20">
              ...
              <li><a href="#" className="text-xs 2xl:text-base font-bold tracking-widest uppercase shadow">Sign Up</a></li>
            </ul>
          </div>
          
          <div className="w-4/12 -mx-5 md:mx-20 flex items-center md:w-3/12 2xl:w-1/12 2xl:-mx-10" style={{marginLeft: "10px"}}>
            <button className="text-xs 2xl:text-base border-4 border-yellow-400 px-2 font-bold uppercase">
              Jadi Tutor
            </button>
          </div>
        </div>
      ...
      <div className="items-center">
        ...
        <div>
          <ul className="space-x-3 md:mx-5 md:w-full md:space-x-10 2xl:-mx-5 flex 2xl:space-x-10" style={{justifyContent: "center"}}>
            <li>
              <button className="-mx-2 px-3 md:px-10 md:py-10 2xl:px-20 2xl:py-10 border-b-8 shadow border-yellow-400 font-semibold rounded-2xl">
                <img src="/math.png" className="mx-2 w-[50px] h-[50px] md:w-[100px] md:h-[100px] 2xl:w-[100px] 2xl:h-[100px]"/>
                <a href="#" className="text-xs 2xl:text-base md:text-base">Matematika</a>
              </button>
            </li>
            <li>
              <button className="-mx-2 px-3 md:px-10 md:py-10 2xl:px-20 2xl:py-10 border-b-8 shadow border-yellow-400 font-semibold rounded-2xl">
                <img src="/fisika.png" className="mx-2 w-[50px] h-[50px] md:w-[100px] md:h-[100px] 2xl:w-[100px] 2xl:h-[100px]"/>
                <a href="#" className="text-xs 2xl:text-base md:text-base">Fisika</a>
              </button>
            </li>
            <li>
              <button className="-mx-2 px-3 md:px-10 md:py-10 2xl:px-20 2xl:py-10 border-b-8 shadow border-yellow-400 font-semibold rounded-2xl">
                <img src="/computer.png" className="mx-2 w-[50px] h-[50px] md:w-[100px] md:h-[100px] 2xl:w-[100px] 2xl:h-[100px]"/>
                <a href="#" className="text-xs 2xl:text-base md:text-base">Komputer</a>
              </button>
            </li>
            <li>
              <button className="-mx-2 px-3 md:px-10 md:py-10 2xl:px-20 2xl:py-10 border-b-8 shadow border-yellow-400 font-semibold rounded-2xl">
                <img src="/lang.png" className="mx-2 w-[50px] h-[50px] md:w-[100px] md:h-[100px] 2xl:w-[100px] 2xl:h-[100px]"/>
                <a href="#" className="text-xs 2xl:text-base md:text-base">Bahasa</a>
              </button>
            </li>
          </ul>
        </div>
