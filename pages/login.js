...
const Login = () => {
    ...
    return (
        ...
        <Container className="flex justify-center shadow-2xl" style={{background: "white", position: "fixed", top: "50%", left: "50%", flexDirection: "column", alignItems: "center", marginRight: "-50%", transform: "translate(-50%, -50%)"}} maxWidth="sm">
            ...
            <h1 className="font-serif text-2xl" style={{display: "flex", justifyContent: "center"}}>Login</h1>
                ...
                <div style={{margin: "20px 0", display: "flexbox", justifyContent: "center"}}>
                    ...
                    <Button style={{margin: "10px"}} variant="contained" color="primary" onClick={handleSubmit}>Login</Button>
                ...
                <div style={{display: "flex", justifyContent: "center"}}>
                    ...
                    <a href="/register/mentee" style={{paddingLeft: "5px", color: "#f4d27b", fontWeight: "bold"}}> Register</a>
                </div>
            </form>
            </div>
        </Container>
